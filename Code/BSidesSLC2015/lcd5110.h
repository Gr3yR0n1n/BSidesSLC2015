...
class LCD5110  
{
    public:
        ...
        void DisplayBitmap(const uint8_t bitmap_array[]); // Write a byte-array coded bitmap to the display. Must be full 504 bytes for now.
    ...
    private:
        // Display buffer
        uint8_t displayBuffer[504]; //Display is 84px x 48px 
